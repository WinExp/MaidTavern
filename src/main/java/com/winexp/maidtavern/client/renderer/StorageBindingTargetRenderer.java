    ...
    public static void tick(TickEvent.ClientTickEvent event) {
        if (event.phase == TickEvent.Phase.END) {
            ...
            int color = switch (type) {
                case INGREDIENTS -> FastColor.ARGB32.color(255, 210, 30, 30);
                case RESULTS -> FastColor.ARGB32.color(255, 30, 210, 30);
                case BYPRODUCTS -> FastColor.ARGB32.color(255, 30, 30, 210);
            };
            for (BlockPos pos : binding.get(type)) {
                cubes.add(new CompiledCube(pos.getCenter(), 1f,
                        FastColor.ARGB32.color(60, FastColor.ARGB32.red(color), FastColor.ARGB32.green(color), FastColor.ARGB32.blue(color)), color));
            }
        }
    }
