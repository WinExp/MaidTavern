...
public class ItemTagsGeneration extends ItemTagsProvider {
    public ItemTagsGeneration(PackOutput output, CompletableFuture<HolderLookup.Provider> lookupProvider, CompletableFuture<TagLookup<Block>> blockTags, ExistingFileHelper existingFileHelper) {
